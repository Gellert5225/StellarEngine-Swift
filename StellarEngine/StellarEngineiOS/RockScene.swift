...
class RocksScene: STLRScene {
    ...
    func setUpCar() {
        let car = STLRModel(modelName: "racing-car", fragmentFunctionName: "fragment_IBL")
    ...
    func setUpRocks() {
        ...
        let rocks = STLRMorph(name: "Rocks", instanceCount: rockInstanceCount,
    ...
    func setUpGrass() {
        ...
        let grass = STLRMorph(name: "grass", instanceCount: grassInstanceCount, textureNames: textureNames, morphTargetNames: morphTargetNames)
        add(childNode: grass)
