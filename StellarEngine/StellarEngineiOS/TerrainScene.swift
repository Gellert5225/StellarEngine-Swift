...
class TerrainScene: STLRScene {
    ...
    func setupScene() {
        ...
        let terrain = STLRTerrain(withSize: [8, 8], heightScale: 1, heightTexture: "mountain", cliffTexture: "cliff-color", snowTexture: "snow-color", grassTexture: "grass-color")
